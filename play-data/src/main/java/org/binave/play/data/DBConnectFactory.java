...
import org.binave.play.api.data.DBConfig;
import org.binave.play.api.data.DBConnect;
...
public class DBConnectFactory {
     ...
     * 获得基础数据库工具
     */
    public static DBConnect createDBConnect(DBConfig dbConfig) {
        try {
    ...
    public static DBConnect createDBConnect(String jdbcUrl) {
