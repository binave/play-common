 ...
 */
@Slf4j
abstract public class JsonDataVerticle<Pojo> extends AbstractVerticle {
    ...
    public void handler(RoutingContext ctx) {
        ...
        try {
            ...
            if (t instanceof IllegalArgumentException) {
                response.setStatusCode(HttpURLConnection.HTTP_BAD_REQUEST).end(msg);

            } else {
                response.setStatusCode(HttpURLConnection.HTTP_INTERNAL_ERROR).end(msg);
